...
public class Virtual_Key {
	public static void main(String[] args) {
		File folder = new File("C:\\Users\\perum\\Desktop\\Simplilearn Assignments");
		folder.mkdirs();
		...
		while (true) {
			...
			System.out.println("2. View Business level Operations:  \n");
			...
			case 2:
				...
				while (temp) {
					...
					switch (choice2) {
					case 1:
						File f = new File("C:\\Users\\perum\\Desktop\\Simplilearn Assignments");
